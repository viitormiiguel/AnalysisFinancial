...
r_investing = open(dInvesting + today +'/polaritySentiLexPre.csv', 'r', encoding='utf8')
# r_investing = open(dInvesting + today +'/polaritySentiLexNo.csv', 'r', encoding='utf8')
posInv = 0 
neuInv = 0 
negInv = 0
...
r_infomoney = open(dInfoMoney + today +'/polaritySentiLexPre.csv', 'r', encoding='utf8')
# r_infomoney = open(dInfoMoney + today +'/polaritySentiLexNo.csv', 'r', encoding='utf8')
posInf = 0
neuInf = 0 
negInf = 0
...
r_tradingview = open(dTrading + today +'/polaritySentiLexPre.csv', 'r', encoding='utf8')
# r_tradingview = open(dTrading + today +'/polaritySentiLexNo.csv', 'r', encoding='utf8')
posTrd = 0
neuTrd = 0 
negTrd = 0
...
# ax.set_title("SentiLex sem Pré-Processamento")
