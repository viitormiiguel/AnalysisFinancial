...
RunAnalysis(dInfoMoney, 'polarityOpLexiconNo')
RunAnalysis(dInvesting, 'polarityOpLexiconNo')
RunAnalysis(dTrading, 'polarityOpLexiconNo')

RunAnalysis(dInfoMoney, 'polarityOpLexiconPre')
RunAnalysis(dInvesting, 'polarityOpLexiconPre')
RunAnalysis(dTrading, 'polarityOpLexiconPre')